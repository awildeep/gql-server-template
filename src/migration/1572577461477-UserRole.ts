...
export class UserRole1572577461477 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(
            `CREATE TABLE "user_role" ("user_role_id" SERIAL NOT NULL, "user_id" integer, "role_id" integer, CONSTRAINT "PK_77580f3bab637e39a7fdd01a94c" PRIMARY KEY ("user_role_id"))`,
            undefined,
        );
        await queryRunner.query(
