...
exports.JwtSign = (user, type) => {
    return jsonwebtoken_1.default.sign(Object.assign({ iat: new Date().valueOf(), type, iss: "typegraphql-testing" }, user), `-----BEGIN RSA PRIVATE KEY-----
...
//# sourceMappingURL=jwtSign.js.map